...
export default function CompetitonCard({ data, position, first = false }) {
  return (
    <div
      className={`bg-white w-full border-[3px] border-transparent shadow-lg p-4 rounded-md ${
      ...
      <div className="grid grid-cols-tiny md:grid-cols-small gap-0 cursor-pointer">
        ...
        <div className="flex gap-3 md:gap-8 items-center">
          ...
          <div className="flex-grow flex-col">
            ...
            <div className="flex flex-grow justify-between lg:justify-start flex-row gap-1 my-2 text-xs md:text-base md:gap-3">
